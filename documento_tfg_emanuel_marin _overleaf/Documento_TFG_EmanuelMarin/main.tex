...
% Título de la tesis
\newcommand{\scriptTitle}{Diseño e Integración de un Módulo PLPUF Programable para Sistemas Embebidos}

% Keywords
\newcommand{\scriptKeywords}{FPGA, Artix-7, PUF, PLPUF, AXI4-Lite, MicroBlaze V, seguridad de hardware, System-on-Chip, Verilog, sistemas embebidos}
