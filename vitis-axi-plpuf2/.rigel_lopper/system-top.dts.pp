# 1 "C:\\Users\\emari\\Desktop\\axi-plpuf-ip\\vitis-axi-plpuf2\\platform\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\Users\\emari\\Desktop\\axi-plpuf-ip\\vitis-axi-plpuf2\\platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\Users\\emari\\Desktop\\axi-plpuf-ip\\vitis-axi-plpuf2\\platform\\hw\\sdt\\pl.dtsi" 1
/ {
 ...
 amba_pl: amba_pl {
  ...
  #address-cells = <1>;
  #size-cells = <1>;
  axi_plpuf_0: axi_plpuf@44a00000 {
   xlnx,s00-axi-data-width = <32>;
   compatible = "xlnx,axi-plpuf-1.0";
   status = "okay";
   xlnx,s00-axi-addr-width = <6>;
   xlnx,ip-name = "axi_plpuf";
   xlnx,edk-iptype = "PERIPHERAL";
   reg = <0x44a00000 0x10000>;
   xlnx,name = "axi_plpuf_0";
  };
  axi_plpuf_1: axi_plpuf@44a10000 {
   xlnx,s00-axi-data-width = <32>;
   compatible = "xlnx,axi-plpuf-1.0";
   status = "okay";
   xlnx,s00-axi-addr-width = <6>;
...
# 3 "C:\\Users\\emari\\Desktop\\axi-plpuf-ip\\vitis-axi-plpuf2\\platform\\hw\\sdt\\system-top.dts" 2
/ {
 board = "basys3";
 ...
 cpus_microblaze_riscv_0: cpus_microblaze_riscv@0 {
  address-map = <0x00000000 &microblaze_riscv_0_local_memory_dlmb_bram_if_cntlr_memory 0x00000000 0x8000>,
         ...
         <0x44a00000 &axi_plpuf_0 0x44a00000 0x10000>,
         <0x44a10000 &axi_plpuf_1 0x44a10000 0x10000>;
